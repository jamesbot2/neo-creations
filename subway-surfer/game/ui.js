...
(function() {
    ...
    SG.showShop = function() {
        ...
        html += '<div style="margin:5px 0;">🔊 Master: <span id="vol-master">' + (SG.state.muted ? 'OFF' : 'ON') + '</span>';
        html += ' <button class="diff-btn" onclick="__neoToggleMuteShop()">TOGGLE</button></div>';
